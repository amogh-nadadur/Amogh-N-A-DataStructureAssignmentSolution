...
public class BinaryTreeSkewed{
	...
	static void ArrayToBSTree(int[] arr, Node root)
	{

		if (root == null)
			return;

		ArrayToBSTree(arr, root.left);
	...
	{
		BstSkewed tree = new BinaryTreeSkewed();
